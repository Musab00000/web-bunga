...
<section class="shopping-cart">
    ...
    <div  class="box">
        ...
        <div class="price"><?php echo format_rupiah($fetch_cart['price']); ?></div>
       ...
       <div class="sub-total"> harga total barang : <span><?php echo format_rupiah($sub_total = ($fetch_cart['price'] * $fetch_cart['quantity'])); ?>,-</span> </div>
    </div>
    <?php
    ...
    <div class="cart-total">
        <p>total harga semua : <span><?php echo format_rupiah($grand_total); ?>,-</span></p>
