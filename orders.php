...
<section class="placed-orders">
    ...
    ?>
    <div class="box">
        <p> dibuat pada : <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
        ...
        <p> metode pebayaran : <span><?php echo $fetch_orders['method']; ?></span> </p>
        <p> pesanan anda : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
        <p> total harga : <span><?php echo format_rupiah($fetch_orders['total_price']); ?>,-</span> </p>
    ...
    <?php
        ...
        echo'<p class="empty">tidak ada order tesedia!</p>';
    }
    ?>
    </div>
